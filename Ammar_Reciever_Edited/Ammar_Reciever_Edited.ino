...
{                                                                                       //Ammar Changes
  ppm[0] = map(data.throttle, 0, 255, 1000, 2000);                                      // I changed swapped the value of the max and minimum mapped values
  ppm[1] = map(data.yaw,      255, 0, 1000, 2000);                                      //This was done for all the inputs of the joysticks that were flipped
  ppm[2] = map(data.pitch,    0, 255, 1000, 2000);
  ppm[3] = map(data.roll,     255, 0, 1000, 2000);
